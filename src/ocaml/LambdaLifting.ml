...
class constant_propagater = object(self)
  ...
  (** @warning Incomplete: nested arrows *)
   ...
   * generated by [e].
   * @result [(updated_tab), (was_updated)]
   * @warning Incomplete: other stmts also generate bindings
  *)
...
class lifter(bounds: string list) = object(self)
   ...
   * @result A pair [(r, extracted)] where [r = (new_name, new_params, b_new)]
